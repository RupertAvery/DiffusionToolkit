...
public class MainWindowViewModel : ViewModelBase
{
    ...
    public MainWindowViewModel()
    {
        ...
        _navigationService.AddNavigationTarget("Search", new SearchPage());
        _navigationService.AddNavigationTarget("Settings", new SettingsPage());
        _navigationService.Navigate += OnNavigate;

        _navigationService.Goto("Search");
        ...
        NavigationMenuItems = new List<NavigationMenuItem>()
        {
            new NavigationMenuItem()
            {
                ...
                Action = () => {
                    ServiceLocator.SearchService.SetView(SearchView.Search);
                    _navigationService.Goto("Search");
                }
            },
            new NavigationMenuItem()
            {
                ...
                Action = () =>
                {
                    ServiceLocator.SearchService.SetView(SearchView.RecycleBin);
                    _navigationService.Goto("Search");
                }
            },
            new NavigationMenuItem()
            {
                ...
                Action = () => {
                    _navigationService.Goto("Settings");
                }
            }
        };
        ...
        ServiceLocator.ScanService.ScanProgress += ScanManagerOnScanProgress;
    ...
    private void RebuildDatabase()
    {
        Task.Run(() =>
        {
            ServiceLocator.ScanService.RebuildMetadata();
        });
    }
    ...
    private void ScanFolders()
    {
        Task.Run(() =>
        {
            ServiceLocator.ScanService.ScanFolders();
        });
    }
    ...
    private Unit SortBy(string parameter)
    {
        ...
        ServiceLocator.SearchService.SetSortBy(parameter);
        return Unit.Default;
    }
    ...
    private Unit SortOrder(string parameter)
    {
        ...
        ServiceLocator.SearchService.SetSortOrder(parameter);
        return Unit.Default;
    }
